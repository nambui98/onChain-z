...
import { AdsCustomSize, AdsFullWidth } from '~/components/Ads'
        ...
        <div className={`HotNews relative ${className ?? ''}`}>
            ...
            <div className="flex gap-8">
                ...
                <div className="mt-10  w-352px ">
                    <AdsCustomSize className='!p-0 h-240px flex items-center justify-center'>
                        Three ads here
                    </AdsCustomSize>
                    <div className={`Subscribe mt-6 p-x-6 h-196px bg-no-repeat bg-center bg-cover flex justify-center items-center flex-col`} style={{
                        backgroundImage: 'url("/assets/images/indepthTopic.png")'
                    }}>
                        <div className="text-2xl font-semibold text-white leading-34px">
                            Keep update about
                            OnChainz!
                        </div>
                        <form className="w-full mt-6">
                            <label class="relative block">
                                <input placeholder="Your email adress" type="email" className="h-64px text-base font-semibold  w-full rounded-[32px] placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500" />
