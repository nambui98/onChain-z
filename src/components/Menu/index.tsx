        ...
        <li className="Nav-item  is-active">
          <a href="#" className="h-full ">
            <div className="group h-full ">
              <button aria-haspopup="true" aria-controls="menu" class="h-full  outline-none focus:outline-none px-3  bg-white rounded-sm flex items-center min-w-32">
