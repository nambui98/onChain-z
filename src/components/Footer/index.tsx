    ...
    <footer className={'AppFooter ' + props.className ?? ''}>
      <div className="md:container max-w-1120px md:mx-auto flex justify-between">
        ...
        <div>
          ...
          <p className="text-xs font-semibold text-grey80 leading-20px mt-4">Short link no 001</p>
          <p className="text-xs font-semibold text-grey80 leading-20px mt-4">Short link no 001</p>
          <p className="text-xs font-semibold text-grey80 leading-20px mt-4">Short link no 001</p>
          <p className="text-xs font-semibold text-grey80 leading-20px mt-4">Short link no 001</p>
        </div>
      ...
      <div className="border-1 p-6 mt-10">
        <div className="md:container max-w-1120px md:mx-auto text-grey text-sm font-semibold">
          {AppConfig.Copyright}
        </div>
      </div>
    </footer>
